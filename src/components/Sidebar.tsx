...
const Sidebar = () => {
  ...
  const getLinkClasses = (path) => {
    const baseClasses = "w-[200px] grow flex gap-5 py-[11px] pl-[11px] pr-[43px] text-[16px] font-bold rounded-[10px]";
      ...
      <div className="top mt-[1px] ml-[24px]">
        ...
        <nav className="flex flex-col mt-[42px] gap-2">
          <div className="flex gap-2">
            ...
            >
              <img src={isActive("/dashboard") ? active : inactive} alt="" /> Dashboard
            </Link>
            {isActive("/dashboard") && (
          ...
          <div className="flex gap-2">
            ...
            >
              <img src={isActive("/dashboard/profile") ? active : inactive} alt="" /> Profile
            </Link>
          ...
          <div className="flex gap-2">
            ...
            >
              <img src={isActive("/projects") ? active : inactive} alt="" /> Projects
            </Link>
            {isActive("/projects") && (
              <div className="bg-[rgba(63,_140,_255,_1)] w-[4px] h-[44px] rounded-[2px]"></div>
            )}
          ...
          <div className="flex gap-2">
            <Link
              to={"/vacations"}
              className={getLinkClasses("/vacations")}
            >
          ...
          <div className="flex gap-2">
            <Link
              to={"/messenger"}
              className={getLinkClasses("/messenger")}
            >
